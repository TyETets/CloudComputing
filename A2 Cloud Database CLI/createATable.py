...
table = dynamodb.create_table(
    TableName='tykema2UN_country_codes',  # replace myUN_country_codes with <username>UN_country_codes
    KeySchema=[
        {
            'AttributeName': 'iso3',
...
db = dynamodb.Table('tykema2_UN_country_codes')   # replace myUN_country_codes with <username>UN_country_codes
